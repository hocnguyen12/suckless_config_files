...
// Volume Commands
/*
static const char *volume[][5] = {
    {"amixer", "-c", "1", "sset", "Master", "5%+"},
    {"amixer", "-c", "1", "sset", "Master", "5%-"},
    {"amixer", "-c", "1", "sset", "Master", "toggle"}
};*/

static const char *volume[][9] = {
    {"amixer", "-c", "1", "sset", "Master", "5%+", "&&", "echo", "Volume Up Command Executed"},
    {"amixer", "-c", "1", "sset", "Master", "5%-", "&&", "echo", "Volume Down Command Executed"},
    {"amixer", "-c", "1", "sset", "Master", "toggle", "&&", "echo", "Mute Command Executed"}
};
